...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, embedding_size=512, zero_init_residual=False, fp16=False):
        super(ResNet, self).__init__()
        self.inplanes = 64

        self.conv1 = conv3x3(3, 32, stride=2)
        self.bn1 = nn.BatchNorm2d(32)
        self.conv2 = conv3x3(32, 32, stride=1)
...
def resnet18_vd(pretrained=False, **kwargs):
...
def resnet34_vd(pretrained=False, **kwargs):
...
def resnet101_vd(pretrained=False, **kwargs):
...
def resnet152_vd(pretrained=False, **kwargs):
